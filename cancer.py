...
# Input/output data
X_data, Y_data = sk.load_breast_cancer(return_X_y=True)
...
with tf.Session(config=config) as sess:
    ...
    mgen.write_walks_to_file_sequentially_one_at_a_time("/mnt/lustre/users/abosman/fla/data/output/cancer/hessian/cancer_hessian", sess)
