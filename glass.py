...
# Input/output data
TRAINING_DATA = "/mnt/lustre/users/abosman/fla/data/input/glass.csv"
...
with tf.Session(config=config) as sess:
    ...
    mgen.write_walks_to_file_sequentially_one_at_a_time("/mnt/lustre/users/abosman/fla/data/output/glass/hessian/glass_hessian", sess)