""" Neural Network.
A 1-Hidden Layer Fully Connected Neural Network (a.k.a Multilayer Perceptron)
...
# Sampling parameters
macro = False                                       # try micro and macro for allstep_size = 0
bounds = 1
step_size = 0.5
...
def one_sim(sess):
    ...
    for walk_counter in range(0, num_walks):
        ...
        for step in range(0, num_steps):
            ...
            ce, mse, acc = sess.run([cross_entropy_op, mse_op, accuracy], feed_dict={X: batch_x, Y: batch_y})
