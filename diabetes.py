...
# Input/output data
TRAINING_DATA = "/mnt/lustre/users/abosman/fla/data/input/diabetes.csv"

data_reader = Data()
data_reader.load(TRAINING_DATA, header=True)
...
with tf.Session(config=config) as sess:
    ...
    mgen.write_walks_to_file_sequentially_one_at_a_time("/mnt/lustre/users/abosman/fla/data/output/diabetes/hessian/diab_hessian", sess)